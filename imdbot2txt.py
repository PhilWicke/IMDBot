...
This twitter bot will take the top 250 titles of imdb.com in order
...
# Number of trials to combine plots in one run of the program
trials = 150
endMsg = 'All current plots used to create more plots, try again later.'
...
for trial in range(trials):
    ...
    if ccPlot:
        ...
        # write down the created plot and wait
        imdpy.write(ccPlot)   
